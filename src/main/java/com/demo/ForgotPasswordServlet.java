...
public class ForgotPasswordServlet extends HttpServlet{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (obtainedPassword != null) {
            ...
            try {
                String sCurrentLine;
                br = new BufferedReader(new FileReader(System.getProperty("user.dir")+"src/main/java/com/demo/credentials.conf"));
				System.out.println(System.getProperty("user.dir")+"src/main/java/com/demo/credentials.conf");
                int i = 0;
